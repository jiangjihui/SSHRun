						...
						<form action="user/login.action" method="post" id="login">
							<table width="100%">
								<tr>
									...
									<td><a href="register.jsp">如何注册</a> ｜ <a
										href="PasswdMissing.jsp"> 忘记密码</a></td>
								</tr>
							</table>
						</form>
					</span>
				...
				<div id="left">
					...
					<div id="hots">
						...
						<ul>
							<li>
								<div>
									<img src="images/a.gif" /> <a href="modify.jsp">基本信息</a>
									<p>可修改自己的基本信息</p>
								</div>
							</li>
							<li>
							...
							<li>
								<div>
									<img src="images/d.gif" /> <a href="noSpace.jsp">个性空间</a>
									<p>创建自己的个性空间</p>
								</div>
							</li>
						</ul>
