...
function validateRegisterForm(form) {
	var nickName = document.forms[0]["memberinfo.nickname"].value;
	var passwd = document.forms[0]["memberinfo.password"].value;
	var passwdre = document.forms[0]["passwdre"].value;
	var email = document.forms[0]["memberinfo.email"].value;
	var passwdQuestion = document.forms[0]["memberinfo.passwordquestion"].value;
	var passwdAnswer = document.forms[0]["memberinfo.passwordanswer"].value;
	var authCode = document.forms[0]["authCode"].value;
	if (isEmpty(nickName)) {
		alert("\u5bf9\u4e0d\u8d77\uff0c\u7528\u6237\u540d\u4e0d\u80fd\u4e3a\u7a7a\uff01");
		return false;
	}
