				...
				<td width="100%">
					<table width="100%" border="0" style="margin: 5px 0;"
		 			...
		 			<tr>
		  			...
		  			<form action="user/createSpace.action" method="post"	enctype="multipart/form-data">
					...
					<tr>
						...
						<TD width="50%" align="left">
							<INPUT class=INPUT1 type=text maxLength=14 name="opinion" value="${sessionScope.memberinfo.memberSpace.opinion }"
					...
					<TR>
						...
						<script type="text/javascript">
							var rh="${memberinfo.memberSpace.runtime}";
							var runhabit=document.getElementsByName("runtime");
							for(var i=0;i<runtime.length;i++)
								{
									if(rh==runtime[i].value)
										{
											runtime[i].checked=true;
										}
								}
						</script>
					</TR>
					<TR>
						...
						<script type="text/javascript">
							var rh="${memberinfo.memberSpace.runhabit}";
							var runhabit=document.getElementsByName("runhabit");
							for(var i=0;i<runhabit.length;i++)
								{
									if(rh==runhabit[i].value)
										{
											runhabit[i].checked=true;
										}
								}
						</script>
					</TR>
