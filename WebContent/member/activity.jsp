  ...
  <div id="header">
    ...
    <div id="mainnav">
      ...
      <span><table width="100%" border="0">
								<tr>
									<td align="right">
										上一次登录时间：<fmt:formatDate value="${sessionScope.memberinfo.latestdate }" pattern="yyyy年MM月dd日" />
									</td>
									<td align="center">
										欢迎，
										<a href="isCreateSpace.action"><font color="red">
												${sessionScope.memberinfo.nickname }</font> </a>&nbsp;
									</td>
									<td align="left">
										当前您的积米：&nbsp;&nbsp;
										<font color="red">${sessionScope.memberinfo.point } </font>&nbsp;&nbsp;
										当前等级：
										<font color="red">${sessionScope.memberinfo.graderecord.gradename }</font>
									</td>
								</tr>
							</table> </span>    </div>
   </div>
        ...
        <div id="hots">
          ...
          <li>
           <div>
            ...
            <a href="messenger/sendInfo.jsp">我的信箱</a>
            <p>写信息、收件箱、发件箱</p>
           </div>
          </li>
          <li>
           <div>
            ...
            <a href="friend/listfriend.action">我的好友</a>
            <p>好友管理及黑名单</p>
           </div>
          </li>
          <li>
           <div>
            ...
            <a href="user/memberSpace.action">个性空间</a>
            <p>创建自己的个性空间</p>
           </div>
          </li>
          </ul>
