     ...
     <div id="center">
       ...
       <div id="ltd">
	     ...
	     <TABLE cellSpacing=0 cellPadding=0 border=0>
	  			<TR>
    				<TD width="100%">
     					<FORM onSubmit="return validateRegisterForm(this);" action="user/register.action" method=post>
     						<TABLE width="100%">
        						<thead>
        						<TR>
         							<TH colSpan=3>
								...
								<TBODY>
       							<TR>
         							<TH width="25%">
          							...
          							<TD width="30%"><INPUT maxLength=14 name="memberinfo.nickname" style="width:200px"></TD>
								...
								<TR>
								  ...
								  <TH><IMG alt=authCode src="authImg" /> 
								</TH></TR>
								<tfoot>
								<TR>
								  <TD colSpan=3>
