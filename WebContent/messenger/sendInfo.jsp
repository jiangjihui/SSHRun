...
<div id="main">
  ...
  <div id="header">
   ...
   <div id="tabs1">
  <ul>
    <li><a href="messenger/sendInfo.jsp" title="写纸条"><span><b>写纸条</b></span></a></li>
  ...
  <div id="content" align="center"> 
     <div id="center"><br/><br/>
		<table width="600">
			...
			<tr>
				<td width="100%">
					<form name="sendInfoForm" action="message/writemessage.action" method="post" onsubmit="return sendInfo(this);">
						<table width="100%">
						<tbody>
						<tr>
							<th width="30%" class="line1" scope="col">收信人：</th>
							<td>
								<input type="text" name="message.receiver" style="width: 250;height: 25" value=""/>
							</td>
						</tr>
						<tr>
							<th>主题：</th>
