...
<script type="text/javascript">
		...
		function addFriend(){
			document.forms.buddyListForm.action="friend/memberlist.action";
		...
		function delBuddy(){
			...
			document.forms.buddyListForm.action="<%=basePath%>friend/removefriend.action";
			document.forms.buddyListForm.submit();		
		}	
</script>
</head>
				...
				<tr>
					<td colspan="2" width="100%">
						<table width="100%">
							...
							<tbody>	
								<c:forEach items="${friendList }" var="m">
								<tr>
									<th width="10%" align="center">
										<input type="checkbox" name="nickName" value="${m.nickname }" />
									</th>								
									...
									<td width="10%" align="center">
										<img src="images/button_del.gif" alt="移动到黑名单" onclick="window.location='friend/removefriend.action?friendname=${m.nickname}'" style="cursor:hand"/>
									</td>
								</tr>							
								</c:forEach>	
							</tbody>						
