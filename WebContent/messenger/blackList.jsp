...
<script type="text/javascript">
		...
		function addFriend(){
			document.forms.blackListForm.action="<%=basePath%>friend/addfriend.action";
		...
		function delBuddy(){
			...
			document.forms.blackListForm.action="<%=basePath%>friend/removeblack.action";
			document.forms.blackListForm.submit();		
		}	
</script>
</head>
							...
							<tbody>				
								...
								<tr>
									...
									<td width="10%" align="center">
										<img src="images/button_del.gif" alt="删除黑名单中的该成员" onclick="window.location='friend/removeblack.action?blackname=${m.nickname}'" style="cursor:hand"/>
									</td>
								</tr>							
								</c:forEach>
							</tbody>						
