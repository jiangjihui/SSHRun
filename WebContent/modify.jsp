     ...
     <div id="center">
		...
		<table width="600">
			<thead>
  			...
  			<tr>
				<td width="100%">
					<form action="user/modify.action" method="post" onSubmit="return validateModifyForm(this);">
					...
					<tr>
						...
						<td width="30%" >
							<input type="text" maxLength="14" style="width:200px" name="nickName" disabled value="${ memberinfo.nickname}" />
						</td>
						<th width="45%" >
					...
					<tr>
						...
						<td>
							<input type="password" maxLength="14" style="width:200px" name="oldPasswd" value="" />
						</td>
						<th>&nbsp;
					...
					<tr>
						...
						<th>
							<input style="width:200px" type="text" name="passwdQuestion" value="${ memberinfo.passwordquestion}" />
						</th>
						<th>
					...
					<tr>
						...
						<td>
							<input  type="text" style="width:200px" name="passwdAnswer" value="${ memberinfo.passwordanswer}" />
						</td>
						<th>
					...
					<tr>
						...
						<td>
							<input type="radio" value="0" <c:if test="${memberinfo.gender==0 }">checked="checked"</c:if> name="gender" checked="checked"/>男
							<input type="radio" value="1" <c:if test="${memberinfo.gender==1 }">checked="checked"</c:if> name="gender" />女
						</td>
						<th>&nbsp;	</th>
					</tr>
					<tr>
						...
						<td >
							<select name="provinceCity"><OPTION value="${ memberinfo.provincecity } " ></OPTION>
